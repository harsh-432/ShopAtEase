      ...
      <div className="footer">
        <div className="footerin1">
          <div className="f1">
            ...
            <p>
              Shop at ease is a multi-vendor grocery shopping website where
              local sellers can register their shop and the nearby customers can
              shop from local sellers online.{" "}
            </p>
        ...
        <div className="footerin2">
          <h3>
            © Copyright 2023 Shop at Ease, Inc. All rights reserved
            <p> Anuj Singh, Ariba Fazal, Harsh Sharma, Ravi Singh</p>
          </h3>
