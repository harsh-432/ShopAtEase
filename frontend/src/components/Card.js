...
export default function Card(props) {
  ...
  const handleAddToCart = async () => {
    await dispatch({
      type: "ADD",
      id: props.shopItem._id,
      name: props.shopItem.name,
      price: quantity * props.shopItem.price,
      qty: quantity,
    });
  ...
  return (
    ...
    <div className="card m-3">
      <div className="card" style={{ width: "18rem" }}>
        ...
        {props.shopItem?.images?.length > 0 && (
          <img
            src={props.shopItem?.images[0].url}
            alt="shopItem"
        ...
        <div className="card-body">
          ...
          <div className="quantity">
            {quantity > 1 && (
              <button className="decreament-btn" onClick={decreament}>
                -
              </button>
            )}
            {quantity}

            <button className="increament-btn" onClick={increament}>
              +
            </button>
          </div>
