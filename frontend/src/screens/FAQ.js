  ...
  const faq = [
    {
      ...
      answer:
        "Shop at ease is a multi-vendor grocery shopping website where local sellers can register their shop and the nearby customers can shop from local sellers online.",
    },
    {
      id: 2,
      question: "What is the purpose for this project?",
      answer:
        "➢ To provide the ease of online shopping to the customers without causing loss to the local vendors.➢ Provide online platform to local shop owners where they can list and sell their products.➢ Provide facility to customers where they can compare products from different shops and buys what suits them.➢ Provide facility to customers where they can order items from their regular/desired shop online.➢ Increase the outreach of local vendors thus providing them more customers.",
    },
    {
      id: 3,
      question: "What is the problem in existing system?",
      answer:
        "Although, existing online platforms like Blinkit, Big Basket, Flipkart Grocery do provide grocery shopping but they deliver the products from warehouses due to which the local vendors suffer because their old customers now prefer to save time and do online shopping.",
    },
    {
      id: 4,
